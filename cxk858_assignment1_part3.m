...
sobel_overlay1 = imoverlay(gray, sobel_adjust3, [1 1 .1]);
sobel_overlay2 = imoverlay(gray, sobel_adjust05, [1 1 .1]);
sobel_overlay3 = imoverlay(gray, sobel_adapthist3, [1 1 .1]);
sobel_overlay4 = imoverlay(gray, sobel_adapthist05, [1 1 .1]);
...
canny_overlay1 = imoverlay(gray, canny_adjust3, [1 1 .1]);
canny_overlay2 = imoverlay(gray, canny_adjust05, [1 1 .1]);
canny_overlay3 = imoverlay(gray, canny_adapthist3, [1 1 .1]);
canny_overlay4 = imoverlay(gray, canny_adapthist05, [1 1 .1]);
